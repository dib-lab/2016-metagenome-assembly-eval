...
they did not conduct an assembly based analysis.  This data set was
also used in several other evaluation studies, including gbtools for
binning \cite{Seah2015} and benchmarking of the MEGAHIT assembler
\cite{Li2016}.
...
\cite{metag_one}. Also see \cite{Greenwald2017}.
% @CTB JG: what's the finding?
...
% @CTB name should be full, first time. JG
\hline
\end{tabular}
...
% @CTB mention wall time and CPU time.
...
% @CTB add percent of contigs? (table 8)
