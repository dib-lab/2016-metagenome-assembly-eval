...
\section*{Discussion}
 ...
 \subsection*{Or Megahit Idba shows the lowest number of unaligned reads among different treatments}  
...
\begin{enumerate}
 ...
 \item {\bf Assembly works pretty good} 
  ...
  % \item {\bf Assembly quality is not affected by treatments} 
 %\item {\bf Digital Normalization and Partitioning increase time and memory resource utilization}
 %\item {\bf Re-inflation does not enhance assembly quality but utilizes more time/memory resources} 
