...
both MetaSPAdes and IDBA by 3-9 in memory and 12-23x in time
...
contigs are clearly more closely related to Genbank genomes not in
...
genomic sequence, but (recapitulating several other studies \cite{Vollmers2017}, \cite{metag_one}, \cite{CAMI})
