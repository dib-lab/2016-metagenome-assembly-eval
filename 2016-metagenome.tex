...
memory used by IDBA and SPAdes, respectively.
...
a contaminating genome from an unknown {\em Clostridium} spp.
...
both MetaSPAdes and IDBA by 5-10x in memory and 17-42x in time
...
assembly of these reads - likely the {\em Clostridium} spp. detected
through amplicon sequencing \cite{podar}.
