...
We extracted random samples from raw reads  of size 25\%, 50\%, and 75\% . We applied quality, digital normalization, and partitioning on each sampled set. 
Figure \ref{fig:sampling} shows genome fraction percentages for different assemblies using different coverage. 
