...
sam-calc-refcov-cmp.py}). To draw a coverage profile for the reference, we calculated how many times a reference base is contained in mapped reads using (script {\tt
cov.py}). 
